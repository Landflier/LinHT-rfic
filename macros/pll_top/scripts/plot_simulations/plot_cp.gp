...
# Description: Plots for the cp macro based on ngspice wrdata exports.
#
...
DATA = 'data/cp_tb_tran.txt'   # TODO(pll_top): point at your export
FIG  = 'figures/cp_tb_tran'
...
PLOT = "plot [][0:1] 1/0 title 'TODO(pll_top): edit plot_cp.gp'"
