...
# Description: Plots for the pfd macro based on ngspice wrdata exports.
#
...
DATA = 'data/pfd_tb_tran.txt'   # TODO(pll_top): point at your export
FIG  = 'figures/pfd_tb_tran'
...
PLOT = "plot [][0:1] 1/0 title 'TODO(pll_top): edit plot_pfd.gp'"
