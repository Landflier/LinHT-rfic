...
# Description: Circuit specifications for the cp macro sizing.
#
# This file is the single input of sizing_cp.py (`make sizing`) — edit
...
# anything touching a pygmid lookup belongs in sizing_cp.py.
# The whole file is echoed verbatim into the generated report
# scripts/sizing/sizing_cp.md, so keep the comments meaningful.
# ============================================
