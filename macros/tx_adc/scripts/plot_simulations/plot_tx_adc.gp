...
# Description: Plots for the tx_adc macro based on ngspice wrdata exports.
#
...
DATA = 'data/tx_adc_tb_tran.txt'   # TODO(tx_adc): point at your export
FIG  = 'figures/tx_adc_tb_tran'

# Common style
set grid back linetype -1 dashtype 3 linecolor rgb '#c0c0c0'
set key top right

# TODO(tx_adc): axis setup + plot command, e.g. a transient plot:
# set xlabel 't (ms)'
# set ylabel 'V (V)'
# PLOT = "plot DATA skip 1 using ($1*1e3):2 with lines linewidth 2 linecolor rgb '#0c5da5' title 'v(out)'"
PLOT = "plot [][0:1] 1/0 title 'TODO(tx_adc): edit plot_tx_adc.gp'"
