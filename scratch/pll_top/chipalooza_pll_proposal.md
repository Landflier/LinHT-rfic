...
The PLL multiplies a 5–50 MHz reference up to a 31.25 MHz – 1 GHz output clock.
...
programmable feedback divider (N = 5–160), output post-divider
...
|---|---|---|---|---|
| Output frequency | 31.25 MHz | — | 1 GHz | VCO covers 250 MHz–1 GHz at all corners, −40…125 °C |
| Multiplication factor N | 5 | — | 160 | — |
